...
export const SpotlightCard: React.FC<SpotlightCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className={`group relative rounded-3xl backdrop-blur-xl border bg-gradient-to-br from-white/5 to-transparent transition-all duration-500 ${
        hoverable
          ? 'hover:scale-[1.02] hover:shadow-[0_30px_60px_rgba(182,137,56,0.15)]'
          : ''
      } ${className}`}
      style={{
