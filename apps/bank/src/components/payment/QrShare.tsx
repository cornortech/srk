...
const QrShare = () => {
    ...
    const handleCopyQR = () => {
        navigator.clipboard.writeText(`https://srkbank.com/pay/${srkBank?.accountNumber}`)
        setCopiedQR(true)
        ...
        <div className="space-y-6">
            ...
            <div className="text-center">
                <div
                    ...
                    style={{
                        background: "linear-gradient(135deg, #1a1410 0%, #2a2520 50%, #1a1410 100%)"
                    }}
                >
                    <div
                    ...
                    <div className="w-64 h-64 bg-white rounded-2xl flex items-center justify-center relative z-10">
                        <div className="text-center p-4">
                            {/* <QrCode className="w-48 h-48 mx-auto text-black" strokeWidth={1} /> */}
                            {qrUrl ? <img src={qrUrl} alt="QR Code" className="w-48 h-48" /> : "Loading..."}
                    ...
                    <div className="mt-4 relative z-10">
                        ...
                        <p className="text-white font-mono font-bold">{srkBank?.accountNumber}</p>
                    </div>
                </div>
            </div>
