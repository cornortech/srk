...
export default function SendMoneySuccessPage() {
  ...
  const { amount, description, receiverAccountName, receiverAccountNumber } =
    useSendMoneyStore();
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <div
            ...
            style={{
              background:
                'linear-gradient(125deg, rgba(225, 186, 115, 0.2), rgba(182, 137, 56, 0.2))',
        ...
        <Card className="bg-[#1a1a1a] border border-[#b68938]/40 shadow-2xl shadow-[#b68938]/10 rounded-2xl mb-4 sm:mb-6">
          <CardBody className="space-y-3 sm:space-y-4 p-4 sm:p-6">
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(125deg, rgba(225, 186, 115, 0.1), rgba(182, 137, 56, 0.1))',
