...
import { getBankStatementOfUserApi } from '../../libs/axios';
...
const BankStatement = () => {
  ...
  const { data: bankStatementData, isLoading } = useQuery<
    TBankStatement[] | undefined
  >({
                ...
                <CardBody className="p-4 space-y-3">
                  ...
                  <div className="text-center py-2">
                    <span
                      ...
                      style={{ color: style.color }}
                    >
                      {style.sign}${Math.abs(statement.amount).toLocaleString()}
                    </span>
                  </div>
