            ...
            <div className="grid md:grid-cols-2 gap-4 sm:gap-5">
              ...
              <Card className="bg-[#2a2520] border border-[#b68938]/40 rounded-xl">
                <CardHeader className="pb-3 sm:pb-4">
                  <div
                    className="flex items-center gap-2 sm:gap-3 text-base sm:text-lg font-semibold"
                    style={{ color: '#b68938' }}
                  >
                ...
                <CardBody className="space-y-3 sm:space-y-4 pt-0">
                  {[
                    ...
                    {
                      label: 'Date of Birth',
                      value: registrationData.dateOfBirth || 'Not provided',
                    },
                    {
                      label: 'Gender',
                      value: registrationData.gender || 'Not provided',
                    },
                  ].map((item, idx) => (
                    <div key={idx}>
              ...
              <Card className="bg-[#2a2520] border border-[#b68938]/40 rounded-xl">
                ...
                <CardBody className="space-y-3 sm:space-y-4 pt-0">
                  {[
                    {
                      label: "Father's Name",
                      value: registrationData.fatherName || 'Not provided',
                    },
                    {
                      label: "Mother's Name",
                      value: registrationData.motherName || 'Not provided',
                    },
                    {
                      label: 'Marital Status',
                      value: registrationData.maritalStatus || 'Not provided',
                    },
                      ...
                      : []),
                    {
                      ...
                      value:
                        registrationData.emergencyContact || 'Not provided',
                    },
                  ].map((item, idx) => (
                    <div key={idx}>
                      <p className="text-xs sm:text-sm text-gray-400">
              ...
              <Card className="bg-[#2a2520] border border-[#b68938]/40 rounded-xl">
                ...
                <CardBody className="space-y-3 sm:space-y-4 pt-0">
                  <div>
                    ...
                    <p className="text-white font-medium text-sm sm:text-base">
                      {registrationData.permanentStreet || 'Not provided'}
                    </p>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <p className="text-white font-medium text-sm sm:text-base">
                        {registrationData.permanentCity || 'Not provided'}
                      </p>
                    </div>
                    <div>
                      <p className="text-xs sm:text-sm text-gray-400">State</p>
                      <p className="text-white font-medium text-sm sm:text-base">
                        {registrationData.permanentState || 'Not provided'}
                      </p>
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <p className="text-white font-medium text-sm sm:text-base">
                        {registrationData.permanentZip || 'Not provided'}
                      </p>
                    </div>
                    <div>
                      <p className="text-xs sm:text-sm text-gray-400">
                      ...
                      <p className="text-white font-medium text-sm sm:text-base">
                        {registrationData.permanentCountry || 'Not provided'}
                      </p>
                    </div>
                  </div>
                </CardBody>
                  ...
                  {registrationData.sameAsPermanent ? (
                    ...
                    <>
                      <div>
                        ...
                        <p className="text-white font-medium text-sm sm:text-base">
                          {registrationData.currentStreet || 'Not provided'}
                        </p>
                      </div>
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <p className="text-white font-medium text-sm sm:text-base">
                            {registrationData.currentCity || 'Not provided'}
                          </p>
                        </div>
                        <div>
                          <p className="text-xs sm:text-sm text-gray-400">
                          ...
                          <p className="text-white font-medium text-sm sm:text-base">
                            {registrationData.currentState || 'Not provided'}
                          </p>
                        </div>
                      </div>
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <p className="text-white font-medium text-sm sm:text-base">
                            {registrationData.currentZip || 'Not provided'}
                          </p>
                        </div>
                        <div>
                          <p className="text-xs sm:text-sm text-gray-400">
                          ...
                          <p className="text-white font-medium text-sm sm:text-base">
                            {registrationData.currentCountry || 'Not provided'}
                          </p>
                        </div>
                      </div>
                    </>
              ...
              <Card className="bg-[#2a2520] border border-[#b68938]/40 rounded-xl">
                ...
                <CardBody className="space-y-3 sm:space-y-4 pt-0">
                  {[
                    {
                      label: 'ID Type',
                      value: registrationData.idType || 'Not provided',
                    },
                    {
                      label: 'ID Number',
                      value: registrationData.idNumber || 'Not provided',
                    },
                    {
                      label: 'Issue Date',
                      value: registrationData.idIssueDate || 'Not provided',
                    },
                    {
                      label: 'Expiry Date',
                      value: registrationData.idExpiryDate || 'Not provided',
                    },
                    {
                      label: 'Issuing Authority',
                      value:
                        registrationData.issuingAuthority || 'Not provided',
                    },
                  ].map((item, idx) => (
                    <div key={idx}>
                      <p className="text-xs sm:text-sm text-gray-400">
              ...
              <Card className="bg-[#2a2520] border border-[#b68938]/40 rounded-xl">
                ...
                <CardBody className="space-y-3 sm:space-y-4 pt-0">
                  {[
                    ...
                    {
                      label: 'Address Proof',
                      value: registrationData.addressProof
                        ? '✓ Uploaded'
                        : 'Not uploaded',
                    },
                    {
                      label: 'Income Proof',
                      value: registrationData.incomeProof
                        ? '✓ Uploaded'
                        : 'Not uploaded',
                    },
                    {
                      label: 'Additional Documents',
                      value: registrationData.additionalDocs
                        ? '✓ Uploaded'
                        : 'Not uploaded',
                    },
                  ].map((item, idx) => (
