...
import QrScan from "../../../components/features/payment/QrScan";
import QrShare from "../../../components/features/payment/QrArea";
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400">Scan or share QR codes for instant payments</p>
            </div>
          </div>
        </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Quick and secure transactions</p>
                  </div>
                </div>
              </div>
              ...
              <div className="px-6 pt-6">
                <div className="flex gap-2 p-1 rounded-2xl bg-black/50">
                  <button
                    ...
                    className={`flex-1 py-3 px-4 rounded-xl font-semibold transition-all ${activeTab === "scan"
                      ? "text-white shadow-lg"
                      : "text-gray-400 hover:text-white"
                      }`}
                    style={{
                      background: activeTab === "scan"
                  ...
                  <button
                    ...
                    className={`flex-1 py-3 px-4 rounded-xl font-semibold transition-all ${activeTab === "share"
                      ? "text-white shadow-lg"
                      : "text-gray-400 hover:text-white"
                      }`}
                    style={{
                      background: activeTab === "share"
                        ? "linear-gradient(135deg, #e1ba73, #b68938)"
                        : "transparent"
                    }}
                  >
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-[#1a1a1a] rounded-3xl border border-[#b68938]/40 p-6">
              ...
              <div className="space-y-3">
                {[
                  { name: "Coffee Shop", amount: 12.50, time: "2 hours ago" },
                  { name: "Grocery Store", amount: 45.00, time: "Yesterday" },
            ...
            >
              ...
              ></div>
              <h3 className="text-lg font-bold mb-3 relative z-10">💡 Quick Tips</h3>
              <ul className="space-y-2 relative z-10">
                <li className="text-sm text-gray-300">• QR payments are instant and secure</li>
                <li className="text-sm text-gray-300">• No fees for QR transactions</li>
                <li className="text-sm text-gray-300">• Works with any QR-enabled app</li>
              </ul>
            </div>
          </div>
        </div>
