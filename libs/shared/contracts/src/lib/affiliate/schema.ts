...
// Inferred types
export type GetAllAffiliateRequestsByStatus = z.infer<typeof getAllAffiliateRequestsByStatusSchema>;
export type GetTeamsOfUser = z.infer<typeof getTeamsOfUserSchema>;
