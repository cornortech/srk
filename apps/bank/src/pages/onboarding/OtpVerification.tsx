                    ...
                    <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                        ...
                        >
                            ...
                            <div className="leading-relaxed">
                                For demo purposes, use OTP: <strong className="font-bold">123456</strong>
                            </div>
                        </div>
                        ...
                        <Input
                            ...
                            maxLength={6}
                            classNames={{
                                input: "text-center text-2xl sm:text-3xl tracking-widest text-white font-semibold",
                                inputWrapper: "bg-[#2a2520] border-[#b68938]/40 hover:border-[#b68938]/60 focus-within:border-[#b68938] transition-colors h-14 sm:h-16",
                        ...
                        {canResend ? (
                            ...
                            <div className="flex items-center justify-center gap-2">
                                ...
                                <p className="text-gray-400 text-sm sm:text-base">
                                    Resend OTP in <span style={{color: '#b68938'}} className="font-semibold">{countdown}s</span>
                                </p>
                            </div>
                        )}
                    </div>
