export const upCommingCourses = [
  ...
  //   description:
  //     "Enhance your ability to communicate effectively in both personal and professional settings. Learn verbal, non-verbal, and written communication techniques.",
  //   duration: "6 weeks",
  //   slogan:
