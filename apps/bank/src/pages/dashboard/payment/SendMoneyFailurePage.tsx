    ...
    <div className="min-h-screen w-full bg-black p-4 sm:p-6">
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <div
            className="inline-flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 rounded-full mb-4 animate-pulse"
            style={{
              background:
                'linear-gradient(125deg, rgba(239, 68, 68, 0.2), rgba(220, 38, 38, 0.2))',
        ...
        <Card className="bg-[#1a1a1a] border border-red-500/40 shadow-2xl shadow-red-500/10 rounded-2xl mb-4 sm:mb-6">
          <CardBody className="space-y-3 sm:space-y-4 p-4 sm:p-6">
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(125deg, rgba(239, 68, 68, 0.1), rgba(220, 38, 38, 0.1))',
            ...
            >
              <div
                className="w-5 h-5 flex-shrink-0 mt-0.5 flex items-center justify-center rounded-full"
