...
export default function BankRegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (formData.ppSizePhoto)
            ppSizePhotoUrl = await (await uploadFile(formData.ppSizePhoto, "image")).url;

        if (formData.nationalIdCard)
            nationIdCardUrl = await (await uploadFile(formData.nationalIdCard, "image")).url;
        ...
        try {
            ...
            navigate("/bank/onboarding/otp-verification");
        } catch {
