...
import { TUserBankProfile } from "@srk/shared/types";
import { bankApi } from "@srk/shared/api";


// import { TUserBankProfile } from "../../../lib/types";
...
export default function AccountSettings() {
  ...
  return (
    <div className="min-h-screen bg-black relative top-[10vh] py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-[#1a1a1a] rounded-3xl border border-[#b68938]/40 shadow-2xl shadow-[#b68938]/10 overflow-hidden">
          ...
          >
            <div className="absolute top-0 right-0 w-48 h-48 rounded-full -mr-24 -mt-24"
              style={{
            ...
            <div className="relative z-10 flex items-center gap-6">
              ...
              <div>
                <h2 className="text-2xl font-bold text-white mb-1">{userDetails?.firstName}</h2>
                <p className="text-gray-400 flex items-center gap-2">
                  <span className="text-sm">Account #</span>
                  <span className="font-mono" style={{ color: "#b68938" }}>{srkBank?.accountNumber}</span>
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="bg-[#0f0f0f] rounded-2xl p-5 border border-[#b68938]/20 hover:border-[#b68938]/40 transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-white font-medium">{bankDetails.familyDetails?.fatherName}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#0f0f0f] rounded-2xl p-5 border border-[#b68938]/20 hover:border-[#b68938]/40 transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-white font-medium">{bankDetails.familyDetails?.motherName}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#0f0f0f] rounded-2xl p-5 border border-[#b68938]/20 hover:border-[#b68938]/40 transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-white font-medium">{bankDetails?.permanentAddress?.country}, {bankDetails?.permanentAddress?.district}, {bankDetails?.permanentAddress?.municipality}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#0f0f0f] rounded-2xl p-5 border border-[#b68938]/20 hover:border-[#b68938]/40 transition-all">
                <div className="flex items-center gap-4">
                  <div
                    ...
                    style={{ backgroundColor: "rgba(182, 137, 56, 0.1)" }}
                  >
                    <Calendar className="w-5 h-5" style={{ color: "#b68938" }} />
                  </div>
                  <div className="flex-1">
                    <p className="text-xs text-gray-400 mb-1">Member Since</p>
                    <p className="text-white font-medium">{moment(userDetails?.createdAt).format("MMMM D, YYYY")}</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-xs text-gray-400">Forgot password? Reset it here</p>
                    </div>
                  </div>
                  <ChevronRight className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors" />
                </div>
            ...
            {isChangingPassword && (
              <div className="mt-6 space-y-4">
                <div className="bg-[#0f0f0f] rounded-2xl p-6 border border-[#b68938]/20">
                  <h4 className="text-white font-semibold mb-4">Reset Your Password</h4>
                  <div className="space-y-4">
                    <div>
                      <label className="text-xs text-gray-400 mb-2 block">Current Password</label>
                      <input
                        type="password"
                    ...
                    <div>
                      <label className="text-xs text-gray-400 mb-2 block">Confirm New Password</label>
                      <input
                        type="password"
                        className="w-full bg-black/50 border border-[#b68938]/20 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#b68938]/60 transition-colors"
          ...
          <Link to="/bank/dashboard">
            <button className="w-full bg-[#1a1a1a] rounded-2xl p-5 hover:shadow-lg transition-all border border-[#b68938]/40 group hover:border-[#b68938]/60">
              <div className="flex items-center justify-center gap-3">
                ...
                <span className="text-white font-semibold">Back to Dashboard</span>
              </div>
            </button>
          </Link>
        </div>
